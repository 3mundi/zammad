class Index extends App.ControllerIntegrationBase
  featureIntegration: 'rocket_integration'
  featureName: 'Rocket Chat'
  featureConfig: 'rocket_config'
  description: [
    ['This service sends notifications to your %s channel.', 'Rocket Chat']
    ['To set up this service you need to create a new |"Incoming webhook"| in your %s integration panel, and enter the web hook URL below.', 'Rocket Chat']
  ]
  events:
  ...
  render: =>
    ...
    configureAttributes = [
      ...
      { name: 'webhook',   display: 'Webhook',  tag: 'input', type: 'url',  limit: 200, 'null': false, placeholder: 'https://rocketchat.example.com/...' },
...
class State
  @current: ->
    App.Setting.get('rocket_integration')

App.Config.set(
  'IntegrationRocket'
  {
    name: 'Rocket'
    target: '#system/integration/rocket'
    description: 'Rocket.Chat is the leading free open source team chat Slack alternative.'
    controller: Index
    state: State
  }
  'NavBarIntegrations'
